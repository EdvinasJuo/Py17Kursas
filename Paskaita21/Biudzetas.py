...
class Biudzetas:
    ...
    def prideti_pajamu_irasa(self, suma, siuntejas, papildoma_informacija= None):
    ...
    def parodyti_ataskaita(self):
        for irasas in self.zurnalas:
            if irasas.tipas in PajamuTipas:
                print(f"Pajamu suma: {irasas.suma}. "
                      f"Pajamu tipas: {irasas.tipas}. "
                      f"Papildoma informacija: {irasas.papildoma_informacija}")
            elif irasas.tipas in IslaiduTipas:
                print(f"Islaidu suma: {irasas.suma}. "
                      f"Islaidu tipas: {irasas.tipas}. "
                      f"Papildoma informacija: {irasas.papildoma_informacija}")
